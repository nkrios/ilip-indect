...
class SolsController extends AppController {
    ...
    function view($id = null) {
        ...
        if ($sol['Sol']['pol_id'] == $this->Session->read('pol')) {
            ...
            // menu
            $this->set('pbar', $pbar);
	    //added to show how much content size is left to analyze, instead of the progress bar
            $this->set('dec_tot', $this->get_dir_size('/opt/xplico/pol_'.$sol['Sol']['pol_id'].'/sol_'.$id.'/decode'));
