...
<div class="generic centered">
	<div id="web_view" style="float:left;width:40%;">
	    ...
	    <?php echo $this->Form->create('Edit', array('url' => '/nntp_groups/view/'.$article['Nntp_article']['id']));
		    echo $this->Form->input('relevance', array('options' => $relevanceoptions, 'default' => $article['Nntp_article']['relevance'] ,'empty'=>'-- Choose relevance --'));
		    echo $this->Form->input('comments', array('type'=>'string', 'style' => 'width:400px','default' => $article['Nntp_article']['comments']));
		?>
	    <p/>
