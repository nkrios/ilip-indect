...
<div class="generic centered">
	<div id="web_view" style="float:left;width:40%;">
	    ...
	    <?php echo $this->Form->create('Edit', array('url' => '/rtps/view/'.$rtp['Rtp']['id']));
		    echo $this->Form->input('relevance', array('options' => $relevanceoptions, 'default' => $rtp['Rtp']['relevance'] ,'empty'=>'-- Choose relevance --'));
		    echo $this->Form->input('comments', array('type'=>'string', 'style' => 'width:400px','default' => $rtp['Rtp']['comments']));
		?>
	    <p/>
