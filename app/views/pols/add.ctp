...
<div class="boxstyle_white generic_form">
  <h2 class="shadow-box-bottom"><?php __('New Case'); ?></h2>
    ...
    <?php echo $this->Form->create('Pol');
      ...
      echo $this->Form->input('Pol.name',  array('maxlength'=> 50, 'label' => __('Case name:', true)));
      echo $this->Form->input('Pol.external_ref',  array('maxlength'=> 50, 'label' => __('Category:', true)));
