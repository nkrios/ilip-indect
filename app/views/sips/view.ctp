...
<div class="generic">
<div id="messageframe">
<table id="voip" class="headers-table" summary="Message headers" cellpadding="2" cellspacing="0">
<tbody>
<tr>
...
<tr>
	<td class="header-title"><?php __('Transcription Date:'); ?></td>
...
<tr>
	<td class="header-title"><?php __('Conversation Name:'); ?></td>
	<td class="date pinfo"><?php
		if($conversation['Conversation']['transcription_date']){
...
<div class="generic centered">
	<div id="web_view" style="float:left;width:40%;">
	    ...
	    <?php echo $this->Form->create('Edit', array('url' => '/sips/view/'.$sip['Sip']['id']));
		    echo $this->Form->input('relevance', array('options' => $relevanceoptions, 'default' => $sip['Sip']['relevance'] ,'empty'=>'-- Choose relevance --'));
		    echo $this->Form->input('comments', array('type'=>'string', 'style' => 'width:400px','default' => $sip['Sip']['comments']));
		?>
	    <p/>
