...
<div class="generic boxstyle_white">
	...
	<div id="messageframe">
		<table id="voip" class="headers-table">
			<tbody>
				<tr>
					<th ><?php __('Date:'); ?>&nbsp;</th>
		...
		<div class="generic boxstyle_white">
			...
			<div id="contents_view" class="divamiddle">
				...
				<div class="voip_flash">
					<object codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="500" height="220" id="sound" align="middle">
