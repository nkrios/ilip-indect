...
<div class="generic centered">
	<div id="web_view" style="float:left;width:40%;">
	    ...
	    <?php echo $this->Form->create('Edit', array('url' => '/webmails/view/'.$email['Webmail']['id']));
		    echo $this->Form->input('relevance', array('options' => $relevanceoptions, 'default' => $email['Webmail']['relevance'] ,'empty'=>'-- Choose relevance --'));
		    echo $this->Form->input('comments', array('type'=>'string', 'style' => 'width:400px','default' => $email['Webmail']['comments']));
		?>
	    <p/>
